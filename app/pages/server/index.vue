  ...
  <v-expansion-panels>
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        국내에서 많이 사용하는 클라우드 서버는 AWS, Azure, GCP, NCloud 등의 있습니다. 그중에서 AWS 가장 많이 사용하는 이유는 인지도 면에서 사용한다고 볼 수 있습니다. 또는 AWS
        컴퓨팅 서비스 외에 네트워크, 데이터베이스, 스토리지, 개발자도구, 보안/자격 증명, 애플리케이션 등을 연결하여 사용하기 위해서입니다.<br /><br />
    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        <b>비용 예측 가능성 확보</b><br />
        AWS는 사용량 기반 과금이라, 예산을 정하지 않으면 월말에 예상보다 높은 비용이 청구될 수 있습니다. 미리 예산을 정하면 매달 예상 비용 범위 안에서 운영할 수 있어, 재무 계획 수립에
        유리합니다.<br /><br />
    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        기본적으로 프로젝트 소스와 서버 예산을 분석하여 최소한의 서버를 운영하는데 구축을 해드릴 수 있습니다. 하지만, 동시 사용자가 있는 서버면 확장된 설계를 생각해야 합니다. 확장은 성능, 보안, 배포,
        백업, 운영을 포함합니다. 어떻게 하면 최소한의 비용으로 서버를 구성해서 사용할 수 있을지 다음과 같은 구성을 생각하여 설계를 해드립니다.<br /><br />
    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        <p>
          견적서는 비용만 보여주는 문서가 아니라, 고객님의 서버 환경을 어떻게 설계할지에 대한 설계도이자, 비용 투명성을 보장하고 향후 불필요한 문제를 예방하는 중요한 자료 입니다. 견적서의 내용은 개요,
          아키텍처, 작업일정, 준비물, 작업결과물, 작업비용으로 구성되어 있습니다.<br /><br />

          <b>비용 투명성 확보</b><br />
          서버 구축에는 여러 구성 요소(인스턴스, 스토리지, 네트워크, 보안 등)가 포함됩니다. 견적서를 통해 예상되는 비용을 명확히 안내드려야, 고객님도 불필요한 비용이 발생하지 않고 안심하실 수
          있습니다.<br /><br />

          <b>구성 요소 명확화</b><br />
          견적서는 단순히 금액만이 아니라, 어떤 서비스가 어떻게 구성되는지에 대한 설계도 역할을 합니다. 이를 통해 고객님이 투자하시는 비용이 어디에 사용되는지 한눈에 확인할 수
          있습니다.<br /><br />
    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        ...
        AWS에 어떤 서버, 네트워크, 보안 구성이 되어 있는지 문서로 정리되어 있어야 고객님이 현재 자산 현황을 명확히 알 수 있습니다. 문서가 없으면 시간이 지나면 어떤 서비스가 어디에 쓰이고 있는지 알기
        어려워집니다.<br /><br />
