    ...
    <v-row>
      ...
      <v-col cols="6">
        ...
        <v-card class="my-5" border flat>
          <h3 class="bg-surface-light pa-2"><v-icon class="mr-2">mdi-numeric-2-box</v-icon>아키텍처</h3>
          <v-card-text>
            <v-row>
              <v-col cols="12">
                <div>
                  <div><v-img :src="task?.image " /></div>
                </div>
              </v-col>
            </v-row>
          </v-card-text>
      ...
      <v-col cols="6">
        <v-card border flat>
          <h3 class="bg-surface-light pa-2"><v-icon class="mr-2">mdi-numeric-3-box</v-icon>작업 과정</h3>
          <v-card-text class="py-2">
            <v-timeline side="end" density="compact">
              <v-timeline-item
                v-for="taskItem in process"
                :key="taskItem.step"
                size="x-small"
              >
                <div>
